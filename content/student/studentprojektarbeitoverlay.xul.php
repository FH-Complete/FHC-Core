...
<vbox id="student-projektarbeit" style="overflow:auto;margin:0px;" flex="1">
<popupset>
	<popup id="student-projektarbeit-tree-popup">
		<menuitem label="Entfernen" oncommand="StudentProjektarbeitDelete();" id="student-projektarbeit-tree-popup-delete" hidden="false"/>
	</popup>
</popupset>

<hbox flex="1">
<grid id="student-projektarbeit-grid-detail" style="margin:4px;" flex="1">
		  	<columns  >
				<column flex="1"/>
				<column flex="1"/>
			</columns>
