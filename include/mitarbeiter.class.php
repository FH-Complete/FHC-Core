...
class mitarbeiter extends benutzer
{
	 ...
	 * @return boolean
	 */
	public function getMitarbeiterStg($lektor = true, $fixangestellt = null, $stge = null, $fkt_kurzbz = null, $order = 'studiengang_kz, nachname, vorname, kurzbz', $datum_von = '', $datum_bis = '')
	{
     ...
     * @return boolean
     */
    public function getMitarbeiterForZutrittskarte($filter = null, $fixangestellt = true, $studSemArray = null)
    {
        $qry = "SELECT
