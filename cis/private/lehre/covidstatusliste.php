...
<div class="container-fluid">
	<div class="row">
		<div class="col-lg-6">
			...
			<h2>Gruppen: <?php echo $data['gruppen']; ?> Studiensemester: <?php echo $data['studiensemester']; ?></h2>
			<h3>Lehrende: <?php echo implode(', ',array_unique($arr_lehrende)); ?></h3>
			<h4>generiert: <?php echo $now->format('d.m.Y H:i'); ?></h4>			
