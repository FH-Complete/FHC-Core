				...
				<grid id="student-prestudent-grid-zgv" style="margin:4px;" flex="1">
					...
					<rows>
						<row>
							...
							<!-- ZGV erfuellt -->						  
							<label value="ZGV erfüllt" control="student-prestudent-checkbox-zgverfuellt"/>
							<hbox>
								<checkbox id="student-prestudent-checkbox-zgverfuellt" checked="true" disabled="true"/>
							</hbox>						  
						</row>
						<row>
							...
							<hbox>
								<menulist id="student-prestudent-menulist-zgvmasternation" disabled="true"
									...
									<template>
		   							...
		   							<!-- ZGV Master erfuellt -->
							<label value="ZGV Master erfüllt" control="student-prestudent-checkbox-zgvmaserfuellt"/>
							<hbox>
								<checkbox id="student-prestudent-checkbox-zgvmaserfuellt" checked="true" disabled="true"/>
							</hbox>
						</row>
						<!-- ZGV Doktor --> 
						<row>
