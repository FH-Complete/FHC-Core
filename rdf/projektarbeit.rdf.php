...
function draw_content($row)
{
	...
	$lehreinheit = $row->lehreinheit_id ? new lehreinheit($row->lehreinheit_id) : null;
	echo '
      <RDF:li>
         <RDF:Description id="'.$row->projektarbeit_id.'"  about="'.$rdf_url.'/'.$row->projektarbeit_id.'" >
            ...
            <PROJEKTARBEIT:lehreinheit_stsem><![CDATA['.($lehreinheit ? $lehreinheit->studiensemester_kurzbz : $row->studiensemester_kurzbz).']]></PROJEKTARBEIT:lehreinheit_stsem>
