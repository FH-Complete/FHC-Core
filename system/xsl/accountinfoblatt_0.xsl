...
<xsl:template match="infoblatt">
		<office:text text:use-soft-page-breaks="true" xmlns:office="urn:oasis:names:tc:opendocument:xmlns:office:1.0" xmlns:style="urn:oasis:names:tc:opendocument:xmlns:style:1.0" xmlns:text="urn:oasis:names:tc:opendocument:xmlns:text:1.0" xmlns:table="urn:oasis:names:tc:opendocument:xmlns:table:1.0" xmlns:draw="urn:oasis:names:tc:opendocument:xmlns:drawing:1.0" xmlns:svg="urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0">
			...
			<text:p text:style-name="P8">Tragen Sie in das Formular Ihren Usernamen und Aktivierungscode ein und vergeben Sie ein Passwort für Ihren Account.</text:p>
			<text:p text:style-name="P8"/>
			<text:p text:style-name="P6">Wie melde ich mich am System an?</text:p>
			<text:p text:style-name="P8">Windows XP/7: Melden sie sich an der Domäne TW an indem Sie die Tasten &lt;STRG&gt; + &lt;ALT&gt; + &lt;ENTF&gt; gleichzeitig drücken, danach Accountname und Passwort eingeben.</text:p>
			...
			<text:p text:style-name="P8">Innerhalb des FHTW-Netzwerks wird Ihr Serververzeichnis immer mit dem Laufwerk M: verbunden. Ausserhalb der FH können Sie per SSH bzw. WinSCP auf Ihre Daten auch von zu Hause aus zugreifen.</text:p>
			<text:p text:style-name="P8">Dazu müssen Sie sich mit dem Server <xsl:value-of select="fileserver" /> verbinden.</text:p>
			<text:p text:style-name="P8"/>
			<text:p text:style-name="P6">Wie kann ich meine Mails von zu Hause aus abrufen?</text:p>
			<text:p text:style-name="P1">Eine Anleitung zur Einrichtung Ihres Mail-Clients finden Sie auf https://cis.technikum-wien.at unter dem Punkt FAQ. Eine weitere Möglichkeit, von überall Mails abzurufen, ist unser Webmail Service auf https://webmail.technikum-wien.at</text:p>
			<text:p text:style-name="P8"/>
			<text:p text:style-name="P6">Warum werden meine Einstellungen am Windows XP/7 Desktop nicht gespeichert?</text:p>
			<text:p text:style-name="P8">Alle Studierenden teilen sich dasselbe Profil. Sie können daher keine Einstellungen sichern.</text:p>
			<text:p text:style-name="P8"/>
			<text:p text:style-name="P6">Wo erhalte ich weitere Informationen?</text:p>
			<text:p text:style-name="P8">Die primäre Anlaufstelle für Fragen rund um den Netzwerkbetrieb ist die Webseite</text:p>
			<text:p text:style-name="P8"/>
			<text:p text:style-name="P3">https://cis.technikum-wien.at</text:p>
			<text:p text:style-name="P8"/>
			...
			<text:p text:style-name="P9"/>
			<text:p text:style-name="P10">https://cis.technikum-wien.at/cis/public/accountactivation.php</text:p>
			<text:p text:style-name="P10"/>
			<text:p text:style-name="P8">Enter your user name and activation key. Enter a new password for your account.</text:p>
			<text:p text:style-name="P8"/>
			<text:p text:style-name="P6">System Log-in</text:p>
			<text:p text:style-name="P8">Windows XP/7: Hold down &lt;CTRL&gt; + &lt;ALT&gt; + &lt;DELETE&gt; simultaneously to log in to the domain of the University of Applied Sciences Technikum Wien. Enter your user name (Account) and password in the log-in window.</text:p>
			<text:p text:style-name="P8">Linux: Start your system and choose Linux in the Boot Manager. The system will then launch KDE Log-in</text:p>
			<text:p text:style-name="P8">Manager. Enter your user name (see Account) and password in the log-in window.</text:p>
			<text:p text:style-name="P8"/>
			...
			<text:p text:style-name="P8">connected to volume M:, which contains your personal disk space.</text:p>
			<text:p text:style-name="P8">In Linux, use an SSH client such as Putty to log in to your file server <xsl:value-of select="fileserver" />.</text:p>
			<text:p text:style-name="P8">Make sure not to exceed your quota, as some software will stop functioning in that case.</text:p>
			<text:p text:style-name="P8"/>
			<text:p text:style-name="P6">Access to your files</text:p>
			<text:p text:style-name="P8">From within UAS Technikum Wien, you can always access volume M: in Windows XP and Windows 7. From</text:p>
			<text:p text:style-name="P8">outside, use an SSH or SCP client to connect to <xsl:value-of select="fileserver" />.</text:p>
			<text:p text:style-name="P8"/>
			<text:p text:style-name="P6">Looking for further information?</text:p>
			<text:p text:style-name="P8">For questions concerning the UAS Technikum Wien network services, see</text:p>
			<text:p text:style-name="P8"/>
			<text:p text:style-name="P11">https://cis.technikum-wien.at</text:p>
