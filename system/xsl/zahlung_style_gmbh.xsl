		...
		<style:master-page style:name="Standard" style:page-layout-name="Mpm1">
			<style:header>
				<text:p text:style-name="MP1">
					<draw:frame draw:style-name="Mfr1" draw:name="Bild 3" text:anchor-type="char" svg:x="11.7cm" svg:y="-2.409cm" svg:width="4.86cm" svg:height="2.9cm" draw:z-index="0">
						<draw:image xlink:href="Pictures/logo_gmbh.jpg" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad"/>
					</draw:frame>
				</text:p>
				<text:p text:style-name="MP1"/>
				<text:p text:style-name="MP1"/>
