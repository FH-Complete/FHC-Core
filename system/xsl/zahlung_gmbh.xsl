...
<office:document-content
	...
	<office:automatic-styles>
		...
		<style:style style:name="P9" style:family="paragraph" style:parent-style-name="Standard">
			<style:text-properties style:font-name="Arial" fo:font-size="12pt" fo:font-weight="bold" officeooo:rsid="00086ab6" officeooo:paragraph-rsid="00086ab6" style:font-size-asian="12pt" style:font-size-complex="12pt"/>
		</style:style>
	...
	<office:body>
		<office:text text:use-soft-page-breaks="true" xmlns:office="urn:oasis:names:tc:opendocument:xmlns:office:1.0" xmlns:style="urn:oasis:names:tc:opendocument:xmlns:style:1.0" xmlns:text="urn:oasis:names:tc:opendocument:xmlns:text:1.0" xmlns:table="urn:oasis:names:tc:opendocument:xmlns:table:1.0" xmlns:draw="urn:oasis:names:tc:opendocument:xmlns:drawing:1.0" xmlns:svg="urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0">
			...
			<text:p text:style-name="P12">DVR 4012747</text:p>
			<text:p text:style-name="P12"/>
			<text:p text:style-name="P12"/>
			...
			<xsl:if test="not(buchung/rueckerstattung)">
				<text:p text:style-name="P5">Wir bestätigen hiermit, dass</text:p>
