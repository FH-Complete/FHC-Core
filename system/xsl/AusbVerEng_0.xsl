...
<office:document-content xmlns:office="urn:oasis:names:tc:opendocument:xmlns:office:1.0" xmlns:style="urn:oasis:names:tc:opendocument:xmlns:style:1.0" xmlns:text="urn:oasis:names:tc:opendocument:xmlns:text:1.0" xmlns:table="urn:oasis:names:tc:opendocument:xmlns:table:1.0" xmlns:draw="urn:oasis:names:tc:opendocument:xmlns:drawing:1.0" xmlns:fo="urn:oasis:names:tc:opendocument:xmlns:xsl-fo-compatible:1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:meta="urn:oasis:names:tc:opendocument:xmlns:meta:1.0" xmlns:number="urn:oasis:names:tc:opendocument:xmlns:datastyle:1.0" xmlns:svg="urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0" xmlns:chart="urn:oasis:names:tc:opendocument:xmlns:chart:1.0" xmlns:dr3d="urn:oasis:names:tc:opendocument:xmlns:dr3d:1.0" xmlns:math="http://www.w3.org/1998/Math/MathML" xmlns:form="urn:oasis:names:tc:opendocument:xmlns:form:1.0" xmlns:script="urn:oasis:names:tc:opendocument:xmlns:script:1.0" xmlns:ooo="http://openoffice.org/2004/office" xmlns:ooow="http://openoffice.org/2004/writer" xmlns:oooc="http://openoffice.org/2004/calc" xmlns:dom="http://www.w3.org/2001/xml-events" xmlns:xforms="http://www.w3.org/2002/xforms" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:rpt="http://openoffice.org/2005/report" xmlns:of="urn:oasis:names:tc:opendocument:xmlns:of:1.2" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:grddl="http://www.w3.org/2003/g/data-view#" xmlns:officeooo="http://openoffice.org/2009/office" xmlns:tableooo="http://openoffice.org/2009/table" xmlns:drawooo="http://openoffice.org/2010/draw" xmlns:calcext="urn:org:documentfoundation:names:experimental:calc:xmlns:calcext:1.0" xmlns:loext="urn:org:documentfoundation:names:experimental:office:xmlns:loext:1.0" xmlns:field="urn:openoffice:names:experimental:ooo-ms-interop:xmlns:field:1.0" xmlns:formx="urn:openoffice:names:experimental:ooxml-odf-interop:xmlns:form:1.0" xmlns:css3t="http://www.w3.org/TR/css3-text/" office:version="1.2">
	...
	<office:automatic-styles>
		...
		<style:style style:name="Tabelle1.A2" style:family="table-cell">
			<style:table-cell-properties style:vertical-align="top" fo:padding="0cm" fo:border-left="none" fo:border-right="none" fo:border-top="none"  fo:border-bottom="none" style:writing-mode="lr-tb"/>
		</style:style>
		...
		<style:style style:name="P93" style:family="paragraph" style:parent-style-name="Standard">
			...
			<style:text-properties style:use-window-font-color="true" style:font-name="Arial" fo:font-size="10pt" fo:language="de" fo:country="DE" officeooo:paragraph-rsid="001b6693" style:font-name-asian="Times New Roman" style:font-size-asian="10pt" style:font-name-complex="Arial" style:font-size-complex="10pt" style:language-complex="ar" style:country-complex="SA"/>
		</style:style>
		<style:style style:name="P94" style:family="paragraph" style:parent-style-name="Standard1">
			<style:paragraph-properties fo:line-height="130%"/>
...
<xsl:template match="ausbildungsvertrag">
        <office:text text:use-soft-page-breaks="true" xmlns:office="urn:oasis:names:tc:opendocument:xmlns:office:1.0" xmlns:style="urn:oasis:names:tc:opendocument:xmlns:style:1.0" xmlns:text="urn:oasis:names:tc:opendocument:xmlns:text:1.0" xmlns:table="urn:oasis:names:tc:opendocument:xmlns:table:1.0" xmlns:draw="urn:oasis:names:tc:opendocument:xmlns:drawing:1.0" xmlns:svg="urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0">
			...
			<text:section text:style-name="Sect1" text:name="Bereich1">
				...
				<xsl:if test="svnr = ''"><text:p text:style-name="P94">Keine Sozialversicherungsnummer oder Ersatzkennzeichen vorhanden</text:p></xsl:if>
				<xsl:if test="gebdatum = ''"><text:p text:style-name="P94">Kein Geburtsdatum vorhanden</text:p></xsl:if>
				<xsl:if test="titel_kurzbz = ''"><text:p text:style-name="P94">Kein akademischer Grad vorhanden</text:p></xsl:if>
				<xsl:if test="student_maxsemester = ''"><text:p text:style-name="P94">Keine Ausbildungsdauer vorhanden</text:p></xsl:if>
			...
			<text:section text:style-name="Sect1" text:name="Bereich3">
				...
				<text:p text:style-name="P48">Studienort sind die Räumlichkeiten der FH Technikum Wien, 1200 Wien, Höchstädtplatz und 1210 Wien, Giefinggasse. Bei Bedarf kann der Erhalter einen anderen Studienort in Wien festlegen, außerhochschulische Aktivitäten (zB Exkursionen) können auch außerhalb von Wien stattfinden. </text:p>
				...
				<text:p text:style-name="P61">Die Studentin bzw. der Student hat das Recht, eine Anerkennung nachgewiesener Kenntnisse beim Studiengang zu beantragen. Eine solche Anerkennung setzt voraus, dass die erworbenen Kenntnisse mit dem Inhalt und dem Umfang der Lehrveranstaltung bzw. eines Berufspraktikums gleichwertig sind und bewirkt die Anrechnung der entsprechenden Lehrveranstaltung oder des Berufspraktikums.</text:p>
				<text:p text:style-name="P61"/>
				...
				<text:p text:style-name="P61">Places of training are the premises of the UAS Technikum Wien, 1200 Vienna, Höchstädt-platz and 1210 Vienna, Giefinggasse. If necessary, the operator may specify a different place of study in Vienna. Non-university activities (e.g. excursions) may take place away from Vienna.</text:p>
				<text:p text:style-name="P61"/>
				<text:p text:style-name="Standard">
					<text:span text:style-name="Strong_20_Emphasis">
				...
				<text:list xml:id="list7740817648153666949" text:style-name="WW8Num4">
					<text:list-item>
						<text:p text:style-name="P81">Der Erhalter verpflichtet sich zur ordnungsgemäßen Planung und Durchführung des Studienganges in der Regelstudiendauer. Der Erhalter ist verpflichtet, allfällige Änderungen des akkreditierten Studienganges zeitgerecht bekannt zu geben.</text:p>
					</text:list-item>
				</text:list>
				...
				<text:p text:style-name="P49"/>
				<text:p text:style-name="P49">The training ends with the positive completion of the final examination before a committee for the respective course. After completion of the required examinations, the academic degree <xsl:value-of select="studiengang_typ"/> of Science in Engineering (<xsl:value-of select="titel_kurzbz"/>) is awarded by the University of Applied Sciences Council. </text:p>
				...
				<text:list xml:id="list111613939151866" text:continue-numbering="true" text:style-name="WW8Num4">
					<text:list-item>
						<text:p text:style-name="P81">The operator undertakes to plan and hold the degree program in a proper manner within the expected time period. The operator is obliged to give adequate notice of any changes to the accredited degree program.</text:p>
					</text:list-item>
				</text:list>
				<text:p text:style-name="P65"/>
				<text:list xml:id="list111613941182599" text:continue-numbering="true" text:style-name="WW8Num4">
					<text:list-item>
						<text:p text:style-name="P81">Der Erhalter verpflichtet sich, jedenfalls folgende Dokumente zur Verfügung zu stellen: Studierendenausweis, Diploma Supplement, Urkunde über die Verleihung des akademischen Grades, Studienerfolgsbestätigung, Inskriptionsbestätigung.</text:p>
					</text:list-item>
					<text:list-item>
				...
				<text:list xml:id="list213448935466617" text:continue-numbering="true" text:style-name="WW8Num4">
					<text:list-item>
				...
				<text:p text:style-name="Standard"/>
				<text:p text:style-name="P48">6.2.1 Einhaltung studienrelevanter Bestimmungen</text:p>
				<text:p text:style-name="P48">Die Studentin bzw der Student ist verpflichtet, insbesondere folgende Bestimmungen einzuhalten:</text:p>
				...
				<text:p text:style-name="P48"/>
				<text:p text:style-name="P48">Diese Dokumente sind öffentlich zugänglich unter www.technikum-wien.at.</text:p>
				...
				<text:list xml:id="list213448587972969" text:continue-numbering="true" text:style-name="WW8Num4">
					<text:list-item>
				...
				<text:p text:style-name="Standard"/>
				<text:p text:style-name="P48">6.2.1 Compliance with regulations relevant to the studies</text:p>
				<text:p text:style-name="P48">In particular the student undertakes to comply with the following regulations:</text:p>
				...
				<text:p text:style-name="P48"/>
				<text:p text:style-name="P48">These documents are publically available at www.technikum-wien.at.</text:p>
				<text:p text:style-name="P71">
					<text:soft-page-break/>6.2.2 Studienbeitrag </text:p>
				...
				<text:p text:style-name="P48"/>
				<text:p text:style-name="P48">6.2.3 ÖH-Beitrag</text:p>
				<text:p text:style-name="P48">Gemäß § 4 Abs 10 FHStG sind Studierende an Fachhochschulen Mitglieder der Österreichischen HochschülerInnenschaft (ÖH). Der/Die Studierende hat semesterweise einen ÖH-Beitrag an den Erhalter zu entrichten, der diesen an die ÖH abführt. Die Entrichtung des Betrags ist Voraussetzung für die Zulassung zum Studium bzw. für dessen Fortsetzung.</text:p>
				<text:p text:style-name="P48"/>
				<text:p text:style-name="P48">6.2.4 Kaution </text:p>
				...
				<text:p text:style-name="P71">6.2.2 Tuition Fees</text:p>
				...
				<text:p text:style-name="P74">
					<text:span text:style-name="T32">6.2.5 Unkostenbeitrag </text:span>
				</text:p>
				...
				<text:p text:style-name="P48"/>
				<text:p text:style-name="P48">6.2.6 Lehr- und Lernbehelfe </text:p>
				<text:p text:style-name="P48">Die Anschaffung unterrichtsbezogener Literatur und individueller Lernbehelfe ist durch den Unkostenbeitrag nicht abgedeckt. Eventuelle zusätzliche Kosten, die sich beispielsweise durch die studiengangsbezogene, gemeinsame Anschaffung von Lehr- bzw. Lernbehelfen (Skripten, CDs, Bücher, Projektmaterialien, Kopierpapier etc.) oder durch Exkursionen ergeben, werden von jedem Studiengang individuell eingehoben. <text:bookmark-start text:name="_Ref78863824"/>
				</text:p>
				<text:p text:style-name="P87">6.2.5 Contribution towards Expenses </text:p>
				...
				<text:p text:style-name="P52"/>
				<text:p text:style-name="P52">6.2.6 Teaching Aids and Learning Tools</text:p>
				...
				<text:p text:style-name="P36">
					<text:soft-page-break/>6.2.7 Beibringung persönlicher Daten <text:bookmark-end text:name="_Ref78863824"/>
				</text:p>
				<text:p text:style-name="P34">Die Studentin bzw. der Student ist verpflichtet, persönliche Daten beizubringen, die auf Grund eines Gesetzes, einer Verordnung oder eines Bescheides vom Erhalter <text:span text:style-name="T26">erfasst werden müssen oder zur Erfüllung des Ausbildungsvertrages bzw. für den Studienbetrieb unerlässlich sind.</text:span>
				</text:p>
				<text:p text:style-name="P34"/>
				<text:p text:style-name="P34">6.2.8 Aktualisierung eigener Daten und Bezug von Informationen</text:p>
				<text:p text:style-name="P60">Die Studentin bzw. der Student hat unaufgefordert dafür zu sorgen, dass die von ihr/ihm beigebrachten Daten aktuell sind. Änderungen sind der Studiengangsassistenz unverzüglich schriftlich mitzuteilen. Darüber hinaus trifft sie/ihn die Pflicht, sich von studienbezogenen Informationen, die ihr/ihm an die vom Erhalter zur Verfügung gestellte Emailadresse zugestellt werden, in geeigneter Weise Kenntnis zu verschaffen.</text:p>
				<text:p text:style-name="P71">6.2.7 Providing Personal Data</text:p>
				...
				<text:p text:style-name="P55"/>
				<text:p text:style-name="P55"/>
				<text:p text:style-name="P55">6.2.8 Updating personal data and the retrieval of information</text:p>
				...
				<text:p text:style-name="P58">
					...
					<text:span text:style-name="T53">6.2.9 Verwertungsrechte</text:span>
				</text:p>
				...
				<text:p text:style-name="P35">6.2.10 Aufzeichnungen und Mitschnitte</text:p>
				...
				<text:p text:style-name="P32"/>
				<text:p text:style-name="P32">
					<text:span text:style-name="T53">6.2.11 Geheimhaltungspflicht</text:span>
				...
				<text:p text:style-name="P48"/>
				<text:p text:style-name="P71"/>
				<text:p text:style-name="P48">6.2.9 Exploitation Rights</text:p>
				...
				<text:p text:style-name="P48"/>
				<text:p text:style-name="P48"/>
				<text:p text:style-name="P48">6.2.10 Recordings </text:p>
				...
				<text:p text:style-name="P48"/>
				<text:p text:style-name="P48"/>
				<text:p text:style-name="P48">6.2.11 Confidentiality </text:p>
				...
				<text:p text:style-name="P48"/>
				<text:p text:style-name="P48"/>
				<text:p text:style-name="P87">6.2.12 Unfallmeldung </text:p>
				<text:p text:style-name="P32">Im Falle eines Unfalles mit körperlicher Verletzung des/der Studierenden im Zusammenhang mit dem Studium ist die/der Studierende verpflichtet, diesen innerhalb von drei Tagen dem Studiengangssekretariat zu melden. Dies betrifft auch Wegunfälle zur oder von der FH.</text:p>
				<text:p text:style-name="P32"/>
				<text:p text:style-name="P32">6.2.13 Schadensmeldung </text:p>
				<text:p text:style-name="P32">Im Falle des Eintretens eines Schadens am Inventar der Fachhochschule ist der/die Studierende verpflichtet, diesen innerhalb von drei Tagen dem Studiengangssekretariat zu melden. Allfällige Haftungsansprüche bleiben hiervon unberührt.</text:p>
				<text:p text:style-name="P32"/>
				<text:p text:style-name="P32">6.2.14 Rückgabeverpflichtung bei Studienende </text:p>
				<text:p text:style-name="P32">Die Studentin bzw der Student ist verpflichtet, bei einer Beendigung des Studiums unverzüglich alle zur Verfügung gestellten Gerätschaften, Bücher, Schlüssel und sonstige Materialien zurückzugeben.</text:p>
				<text:p text:style-name="P32"/>
				<text:p text:style-name="P2">
				...
				<text:p text:style-name="P71">6.2.12 Accident Report</text:p>
				<text:p text:style-name="P48">In the event of an accident with bodily injury to a student in connection with his / her studies, he / she is obliged to report this to the administrative assistant of the degree program within three days. This also applies to accidents on the way to or from the UAS. </text:p>
				<text:p text:style-name="P48"/>
				<text:p text:style-name="P48"/>
				<text:p text:style-name="P48">6.2.13 Damage Report</text:p>
				<text:p text:style-name="P48">If any damage should be caused to the inventory of the University of Applied Sciences, the student undertakes to report this to the administrative assistant of the degree program within three days. Any liability claims shall remain unaffected.</text:p>
				<text:p text:style-name="P48"/>
				<text:p text:style-name="P48">6.2.14 Obligation to Return Borrowed Items</text:p>
				<text:p text:style-name="P48">The student undertakes to return promptly all equipment, books, keys and other materials that have been made available, when the course is finished or broken off.</text:p>
				<text:p text:style-name="P48"/>
				<text:p text:style-name="P48"/>
				<text:p text:style-name="P48"/>
				<text:p text:style-name="P48">
				...
				<text:p text:style-name="P12">7.1 Annulment by Mutual Agreement </text:p>
				<text:p text:style-name="P48"/>
				...
				<text:p text:style-name="P51">Nach erfolgreicher Beendigung des Studiums endet der Vertrag automatisch mit der Verleihung des akademischen Grades.</text:p>
				<text:p text:style-name="P51">Der Vertrag endet automatisch durch die negative Beurteilung der letztmöglichen Prüfungswiederholung.</text:p>
				<text:p text:style-name="P51"/>
				<text:p text:style-name="P7">
				...
				<text:list xml:id="list213450332061254" text:continue-numbering="true" text:style-name="WW8Num4">
					<text:list-item>
						<text:p text:style-name="P80">nicht genügender Leistung im Sinne der Prüfungsordnung;</text:p>
					</text:list-item>
					<text:list-item>
						<text:p text:style-name="P80">mehrmalige<text:span text:style-name="T34">m</text:span> unentschuldigte<text:span text:style-name="T34">n</text:span> Verletzen der Anwesenheitspflicht; </text:p>
					</text:list-item>
					<text:list-item>
						<text:p text:style-name="P80">wiederholte<text:span text:style-name="T34">m</text:span> Nichteinhalten von Prüfungsterminen und Abgabeterminen für Seminararbeiten, Projektarbeiten etc.; </text:p>
					</text:list-item>
					<text:list-item>
						<text:p text:style-name="P80">schwerwiegender bzw. wiederholter Verstöße gegen die Hausordnung;</text:p>
					</text:list-item>
					<text:list-item>
						<text:p text:style-name="P80">persönliche<text:span text:style-name="T34">m</text:span> Verhalten, das zu einer Beeinträchtigung des Images und/oder Betriebes des Studienganges, der Fach-hochschule bzw. des Erhalters oder von Personen führt, die für die Fachhochschule bzw. den Erhalter tätig sind;</text:p>
					</text:list-item>
					<text:list-item>
						<text:p text:style-name="P80">Verletzung der Verpflichtung, dem Erhalter die Rechte an Forschungs- und Entwicklungsergebnissen anzubieten (siehe Pkt. 6.2.9);</text:p>
					</text:list-item>
					<text:list-item>
						<text:p text:style-name="P80">Verletzung der Geheimhaltungspflicht (siehe Pkt. 6.2.11); </text:p>
					</text:list-item>
					<text:list-item>
				...
				<text:p text:style-name="P48"/>
				<text:p text:style-name="P48">When the course of study has been completed successfully the contract ends automatically with the awarding of the academic degree.</text:p>
				<text:p text:style-name="P48">The contract ends automatically if the last possible repeat of an examination ends in failure.</text:p>
				<text:p text:style-name="P48"/>
				...
				<text:p text:style-name="P48"/>
				<text:list xml:id="list213448459071629" text:continue-numbering="true" text:style-name="WW8Num4">
					<text:list-item>
					...
					<text:list-item>
						<text:p text:style-name="P80">breach of the obligation to offer the operator the rights to research and development results (see Section 6.2.9);<text:line-break/>
						</text:p>
					</text:list-item>
					<text:list-item>
						<text:p text:style-name="P80">breach of confidentiality (see Section 6.2.11);</text:p>
					</text:list-item>
					<text:list-item>
				...
				<text:list xml:id="list213449462296180" text:continue-numbering="true" text:style-name="WW8Num4">
					<text:list-item>
					...
					<text:list-item>
						<text:p text:style-name="P80">Weigerung zur Beibringung von Daten (siehe Pkt. 6.2.7);</text:p>
					</text:list-item>
					<text:list-item>
				...
				<text:p text:style-name="P48"/>
				<text:p text:style-name="P71"/>
				<text:list xml:id="list213448747044968" text:continue-numbering="true" text:style-name="WW8Num4">
					<text:list-item>
					...
					<text:list-item>
						<text:p text:style-name="P80">refusal to provide any data (see section 6.2.7); </text:p>
					</text:list-item>
					<text:list-item>
				...
				<text:p text:style-name="Standard">
					...
					<text:span text:style-name="T30"> Invalidity of Contractual Provisions</text:span>
				</text:p>
				<text:p text:style-name="P48"/>
				...
				<text:p text:style-name="Standard">
					...
					<text:span text:style-name="T30">Copies, Fees, Place of Jurisdiction, Applicable Law</text:span>
				</text:p>
				<text:p text:style-name="P48"/>
				...
				<table:table table:name="Tabelle1" table:style-name="Tabelle1">
					...
					<table:table-row table:style-name="Tabelle1.1">
						<table:table-cell table:style-name="Tabelle1.A2" office:value-type="string">
							...
							<text:p text:style-name="P28">
								<text:span text:style-name="T36">(The student /<text:line-break/>if necessary legal representatives)</text:span>
							</text:p>
						</table:table-cell>
						<table:table-cell table:style-name="Tabelle1.B1" office:value-type="string">
							<text:p text:style-name="P25"/>
