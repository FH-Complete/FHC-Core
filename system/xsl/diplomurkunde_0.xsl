...
<xsl:template match="pruefung">
	<office:text text:use-soft-page-breaks="true" xmlns:office="urn:oasis:names:tc:opendocument:xmlns:office:1.0" xmlns:style="urn:oasis:names:tc:opendocument:xmlns:style:1.0" xmlns:text="urn:oasis:names:tc:opendocument:xmlns:text:1.0" xmlns:table="urn:oasis:names:tc:opendocument:xmlns:table:1.0" xmlns:draw="urn:oasis:names:tc:opendocument:xmlns:drawing:1.0" xmlns:svg="urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0">
		...
		<text:p text:style-name="P1">Lorem ipsum dolor</text:p>
		<text:p text:style-name="P1"/>
		...
		<text:p text:style-name="P1">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et</text:p>
		<text:p text:style-name="P1">GLorem ipsum dolor sit amet, consetetur sadipscing eli</text:p>
		<text:p text:style-name="P1">fLorem ipsum dolor sit amet, consetetur sadipscing eli</text:p>
		<text:p text:style-name="P1"/>
		<text:p text:style-name="P3"><xsl:value-of select="titel" /></text:p>
		<text:p text:style-name="P1">Lorem ipsum dolor sit amet, consetetur sadipscing eli</text:p>
