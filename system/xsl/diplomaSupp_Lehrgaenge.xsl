...
<!--		<style:table-row-properties style:row-height="1.314cm" fo:keep-together="auto"/> -->
	...
	<style:style style:name="P78" style:family="paragraph" style:parent-style-name="Standard" style:master-page-name="Letzte_20_Seite">
		<style:paragraph-properties style:page-number="auto"/>
	</style:style>
...
<xsl:template match="supplement">
		...
		<xsl:if test="ects_gesamt = ''"><text:p text:style-name="Warning">ECTS-Gesamt wurden nicht gefunden</text:p></xsl:if>
	...
	<text:p text:style-name="Standard">Siehe folgende Seiten</text:p>
		...
		<text:p text:style-name="P79">Certificate Program for Further Education (subjected to §9 FHStG)</text:p>
