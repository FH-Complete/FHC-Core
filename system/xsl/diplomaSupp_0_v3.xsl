...
<xsl:template match="supplement">
	...
	<text:p text:style-name="Standard">Siehe folgende Seiten</text:p>
      ...
      <text:p text:style-name="P74">Stand: 7. November 2011</text:p>
      ...
      <text:list xml:id="list1370974139" text:continue-list="list1154796277" text:style-name="WW8Num16">
        ...
        <text:list-item>
          <text:p text:style-name="P52"><text:soft-page-break/>Das <text:span text:style-name="T14">neue System</text:span> folgt der Trennung zwischen einem Undergraduate-Studium und einem Graduate-Studium. Nach Beendigung des Undergraduate-Studiums (<text:span text:style-name="T15">Bachelorstudium</text:span> an Universitäten; <text:span text:style-name="T15">Fachhochschul-Bachelorstudiengang; Studiengang</text:span> an Pädagogischen Hochschulen; 180 ECTS-Credits) wird ein <text:span text:style-name="T15">Bachelorgrad</text:span> (mit dem Wortlaut „Bachelor of/in ...") verliehen. Nach Beendigung des Graduate-Studiums (<text:span text:style-name="T15">Masterstudium</text:span> an Universitäten mit 120 ECTS-Credits bzw. <text:span text:style-name="T15">Fachhochschul-Masterstudiengang</text:span> mit 60 bis 120 ECTS-Credits) wird ein <text:span text:style-name="T15">Mastergrad</text:span> (mit dem Wortlaut „Master of/in ...") verliehen. In ingenieurwissenschaftlichen Graduate-Studien kann der Mastergrad auch „Diplom-Ingenieur/in" lauten.<text:line-break/></text:p>
        </text:list-item>
      </text:list>
      ...
      <table:table table:name="Table10" table:style-name="Table10">
        ...
        <table:table-row table:style-name="Table10.1">
          ...
          <table:table-cell table:style-name="Table10.B2" office:value-type="string">
            <text:p text:style-name="P33">SEHR GUT:</text:p><text:p text:style-name="P33">Hervorragende Leistung</text:p>
          </table:table-cell>
        </table:table-row>
        <table:table-row table:style-name="Table10.1">
          <table:table-cell table:style-name="Table10.A2" office:value-type="string">
          ...
          <table:table-cell table:style-name="Table10.B2" office:value-type="string">
            <text:p text:style-name="P33">GUT:</text:p><text:p text:style-name="P33">Generell gut, einige Fehler</text:p>
          </table:table-cell>
        </table:table-row>
        <table:table-row table:style-name="Table10.1">
          <table:table-cell table:style-name="Table10.A2" office:value-type="string">
          ...
          <table:table-cell table:style-name="Table10.B2" office:value-type="string">
            <text:p text:style-name="P33">BEFRIEDIGEND:</text:p><text:p text:style-name="P33">Ausgewogen, Zahl entscheidender Fehler</text:p>
          </table:table-cell>
        </table:table-row>
        <table:table-row table:style-name="Table10.1">
          <table:table-cell table:style-name="Table10.A2" office:value-type="string">
          ...
          <table:table-cell table:style-name="Table10.B2" office:value-type="string">
            <text:p text:style-name="P33">GENÜGEND:</text:p><text:p text:style-name="P33">Leistung entsprechen den Minimalkriterien</text:p>
          </table:table-cell>
        </table:table-row>
        <table:table-row table:style-name="Table10.1">
          <table:table-cell table:style-name="Table10.A2" office:value-type="string">
        ...
        <table:table-row table:style-name="Table10.1">
          ...
          <table:table-cell table:style-name="Table10.B2" office:value-type="string">
            <text:p text:style-name="P33">NICHT GENÜGEND:</text:p><text:p text:style-name="P33">Erhebliche Verbesserungen erforderlich, Erfordernis weiterer Arbeit</text:p>
          </table:table-cell>
        </table:table-row>
        <table:table-row table:style-name="Table10.1">
          <table:table-cell table:style-name="Table10.A2" office:value-type="string">
      ...
      <table:table table:name="Table14" table:style-name="Table14">
         ...
         <table:table-row>
            <table:table-cell table:style-name="Table14.A1" office:value-type="string">
               <text:p text:style-name="P33">Noten für Gesamtprüfungen:</text:p>
            </table:table-cell>
            <table:table-cell table:style-name="Table14.A1" office:value-type="string">
            ...
            <table:table-cell table:style-name="Table14.A1" office:value-type="string">
               ...
               <text:p text:style-name="P33">mit Erfolg bestanden</text:p>
	  ...
	  <text:p text:style-name="P73">Bundesministerium für Wissenschaft und Forschung</text:p>
	  <text:p text:style-name="P73">Abteilung III/7</text:p>
	  <text:p text:style-name="P73">November 2011</text:p>
      <text:p text:style-name="P8"/>
      <text:p text:style-name="P56">APPENDIX: Information on the Austrian higher education system</text:p>
      <text:p text:style-name="P76">As of 7<text:span text:style-name="T5">th</text:span> November 2011</text:p>
      ...
      <text:list xml:id="list695069009" text:continue-list="list282475735" text:style-name="WW8Num13">
        <text:list-item>
          <text:list>
            ...
            <text:list-item>
              <text:p text:style-name="P50">maintainers of university of applied sciences degree programs (<text:span text:style-name="T15">Fachhochschul-Studiengänge</text:span>) incorporated upon the basis of private or public law and subsidized by the state, with state accreditation (some of which are entitled to use the designation <text:span text:style-name="T15">Fachhochschule</text:span>);</text:p>
            </text:list-item>
            <text:list-item>
      ...
      <text:list xml:id="list119325670" text:continue-list="list695069009" text:style-name="WW8Num13">
        <text:list-item>
          <text:list>
            <text:list-item>
              <text:p text:style-name="P50">academies for midwifery (<text:span text:style-name="T15">Hebammenakademien</text:span>);</text:p>
            </text:list-item>
            <text:list-item>
              <text:p text:style-name="P50">clinical technical academies (<text:span text:style-name="T15">Medizinisch-Technische Akademien</text:span>);</text:p>
            </text:list-item>
            <text:list-item>
              <text:p text:style-name="P50">military academies (<text:span text:style-name="T15">Militärische Akademien</text:span>);</text:p>
            </text:list-item>
            <text:list-item>
              <text:p text:style-name="P50">the school of international studies (<text:span text:style-name="T15">Diplomatische Akademie</text:span>);</text:p>
            </text:list-item>
            <text:list-item>
      ...
      <table:table table:name="Table11" table:style-name="Table11">
        ...
        <table:table-row table:style-name="Table11.1">
          ...
          <table:table-cell table:style-name="Table11.B2" office:value-type="string">
            <text:p text:style-name="P32">EXCELLENT:</text:p><text:p text:style-name="P32">Outstanding performance</text:p>
          </table:table-cell>
        </table:table-row>
        <table:table-row table:style-name="Table11.1">
          <table:table-cell table:style-name="Table11.A2" office:value-type="string">
          ...
          <table:table-cell table:style-name="Table11.B2" office:value-type="string">
            <text:p text:style-name="P32">GOOD:</text:p><text:p text:style-name="P32">Generally good, but with some errors</text:p>
          </table:table-cell>
        </table:table-row>
        <table:table-row table:style-name="Table11.1">
          <table:table-cell table:style-name="Table11.A2" office:value-type="string">
          ...
          <table:table-cell table:style-name="Table11.B2" office:value-type="string">
            <text:p text:style-name="P32">SATISFACTORY:</text:p><text:p text:style-name="P32">Generally sound work with a number of substantial errors</text:p>
          </table:table-cell>
        </table:table-row>
        <table:table-row table:style-name="Table11.1">
          <table:table-cell table:style-name="Table11.A2" office:value-type="string">
          ...
          <table:table-cell table:style-name="Table11.B2" office:value-type="string">
            <text:p text:style-name="P32">SUFFICIENT:</text:p><text:p text:style-name="P32">Performance meets the minimum criteria</text:p>
          </table:table-cell>
        </table:table-row>
        <table:table-row table:style-name="Table11.1">
          <table:table-cell table:style-name="Table11.A2" office:value-type="string">
        ...
        <table:table-row table:style-name="Table11.1">
          ...
          <table:table-cell table:style-name="Table11.B2" office:value-type="string">
            <text:p text:style-name="P32">UNSATISFACTORY: &lt;50%</text:p><text:p text:style-name="P32">Substantial improvement necessary: requirement of further work</text:p>
          </table:table-cell>
        </table:table-row>
        <table:table-row table:style-name="Table11.1">
          <table:table-cell table:style-name="Table11.A2" office:value-type="string">
      ...
      <table:table table:name="Table15" table:style-name="Table15">
         ...
         <table:table-row>
            <table:table-cell table:style-name="Table15.A1" office:value-type="string">
               <text:p text:style-name="P32">Grades for comprehensive examinations</text:p>
               <text:p text:style-name="P32">covering materials from various subjects:</text:p>
            </table:table-cell>
            <table:table-cell table:style-name="Table15.A1" office:value-type="string">
            ...
            <table:table-cell table:style-name="Table15.A1" office:value-type="string">
			   <text:p text:style-name="P32"/>
               <text:p text:style-name="P32">mit Auszeichnung bestanden</text:p>
               <text:p text:style-name="P32">mit Erfolg bestanden</text:p>
               <text:p text:style-name="P32">bestanden</text:p>
            </table:table-cell>
         </table:table-row>
         <table:table-row>
		    <table:table-cell table:style-name="Table15.A1" office:value-type="string">
            ...
            <table:table-cell table:style-name="Table15.A1" office:value-type="string">
               <text:p text:style-name="P32">nicht bestanden</text:p>
            </table:table-cell>
         </table:table-row>
      </table:table>
      <text:p text:style-name="P17"/>
	  <text:p text:style-name="P75">Source:</text:p>
	  <text:p text:style-name="P75">Federal Ministry of Science and Research</text:p>
	  <text:p text:style-name="P75">Unit III/7</text:p>
	  <text:p text:style-name="P75">November 2011</text:p>
