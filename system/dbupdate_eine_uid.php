...
if(!isset($_POST["action"]) || $_POST["action"] != "start")
{
	...
	echo "<p>";
		...
		echo "<div>bis.tbl_bisio: student_uid wird <strong style='color:red;'>gelöscht</strong>!</div>";
		echo "<div>bis.tbl_bisio: prestudent_id wird <strong style='color:green;'>eingefügt</strong>!</div>";
...
$error=false;
$sql_query="SELECT schemaname,tablename FROM pg_catalog.pg_tables WHERE tablename = 'tbl_bisio';";
