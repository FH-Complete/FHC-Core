...
$tabellen=array(
	...
	"public.tbl_profil_update" => array("profil_update_id","uid","name","topic","requested_change", "updateamum", "updatevon", "insertamum", "insertvon", "status", "status_timestamp", "status_message", "attachment_id"),
