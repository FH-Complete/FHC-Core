...
$status_kurzbz=array('Interessent','Bewerber','Student','Ausserordentlicher','Abgewiesener','Aufgenommener','Wartender',
		'Abbrecher','Unterbrecher','Outgoing','Incoming','Praktikant','Diplomant','Absolvent');
for ($i=0; $i<=13; $i++)
{
	$qry="INSERT INTO public.tbl_status(status_kurzbz, beschreibung, anmerkung, ext_id) VALUES('".
		$status_kurzbz[$i]."', null, null,'".($i+1)."');";
	pg_query($conn,$qry);
}
