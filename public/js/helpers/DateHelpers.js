...
export function numberPadding(number) {
	if (typeof number !== "string" && typeof number !== "number") {
		throw new TypeError(
			"function numberPadding in file DateHelpers.js is only usable with strings or numbers",
		);
	}
	if (number.toString().length > 2) {
		throw new DateHelperError(
			"The number on which the padding should be added should not be longer than to 2 characters, please refere to the function numberPadding in the helper file DateHelpers.js",
		);
	}
...
export function formatDate(d) {
	...
	// parameter is not of type string or Date and an exception is thrown
		...
		throw new TypeError(
			"The parameter provided for this function is not a string or a Date object, please refere to the function formatDate in the DateHelpers.js file",
		);
	}
}
