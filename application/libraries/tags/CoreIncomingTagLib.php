...
class CoreIncomingTagLib
{
	...
	public function getZuordnungIds(array $params)
	{
		...
		$result = $this->ci->BisioModel->getIncomingsOfSemester($semester);
	...
	public function isCriteriaSetFor(array $params)
	{
		...
		$result = $this->ci->BisioModel->isPrestudentIncoming($semester, $prestudent_id);
