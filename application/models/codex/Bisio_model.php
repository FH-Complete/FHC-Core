...
class Bisio_model extends DB_Model
{
	...
	/**
	 * Gets incoming students of certain Semester
	 * @param String studiensemester_kurzbz
	 * @return array of prestudent_ids
	 */
	public function getIncomingsOfSemester($studiensemester_kurzbz)
	{
		$query = "
			SELECT DISTINCT ps.prestudent_id, tbl_bisio.von, tbl_bisio.bis
			FROM bis.tbl_bisio
	...
	public function isPrestudentIncoming($studiensemester_kurzbz, $prestudent_id)
	{
		$query = "
			SELECT
				ps.prestudent_id, tbl_bisio.von, tbl_bisio.bis
