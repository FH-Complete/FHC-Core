...
<title>Firmen Zusammenlegung</title>
	...
	<!--
		...
		function set_firmen_search_links(wohin,filter,firmentypkurzbz)
		{
		   		$("div#infodetail").html('');
    	       	$("div#info").hide("slow");
	...
	<table width="100%">
		<tr>
			<td colspan="2" align="center">
					...
					&nbsp;<input type="button" name="suchen1" value="nur nach Typ suchen" onclick="$('#filter1').val('') ; $('#filter2').val('');set_firmen_search_rechts('geloescht','filter','firmentyp_kurzbz');set_firmen_search_links('bleibt','filter','firmentyp_kurzbz');">
			</td>
		</tr>
		<tr><td>&nbsp;</td></tr>
		<tr>
			...
			<tr>
				<td>&nbsp;Suche:&nbsp;<input type="text" id="filter1" name="filter1" value="<?php echo $filter1;?>">
					&nbsp;<input type="button" name="suchen1" value="suchen" onclick="set_firmen_search_rechts('geloescht','filter1','firmentyp_kurzbz');">
				</td>
			</tr>				
			</table>
			</td>
			...
			<tr>
				<td>&nbsp;Suche:&nbsp;<input type="text" id="filter2" name="filter2" value="<?php echo $filter2;?>">
					&nbsp;<input type="button" name="suchen2" value="suchen" onclick="set_firmen_search_links('bleibt','filter2','firmentyp_kurzbz');">
				</td>
			</tr>				
			</table>
			</td>
